...
files_and_fields = [
    ("eli5_report_gpto4.jsonl", "gpto4_judgment"),
    ("eli5_report_qwen.jsonl", "qwen_judgment"),
    ("eli5_report_gemini.jsonl", "gemini_judgment"),
]
nli_file = "eli5_report_nli.jsonl"
save_file = "eli5_report_ensemble.jsonl"
